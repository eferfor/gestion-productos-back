...
public class ProductController {
	...
	@PostMapping
	public ResponseEntity<ProductDTO> crearProducto(@RequestBody ProductDTO p){
	...
	@PutMapping("/{id}")
	public ResponseEntity<ProductDTO> modificarProducto(@PathVariable Long id, @RequestBody ProductDTO p){
		return ResponseEntity.ok(service.modificarProducto(id, p));
	}
	
	@DeleteMapping("/{id}")
	public ResponseEntity<Void> eliminarProducto(@PathVariable Long id){
		service.eliminarPorducto(id);
